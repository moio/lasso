...
// Source: github.com/rancher/lasso/pkg/cache/sql/db (interfaces: Rows,Connection,Encryptor,Decryptor,TXClient,DBClient)
...
// Begin mocks base method.
func (m *MockDBClient) Begin() (TXClient, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Begin")
	ret0, _ := ret[0].(TXClient)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockDBClient) CloseStmt(arg0 Closable) error {
	m.ctrl.T.Helper()
...
func (m *MockDBClient) ReadObjects(arg0 Rows, arg1 reflect.Type, arg2 bool) ([]interface{}, error) {
	m.ctrl.T.Helper()
...
func (m *MockDBClient) ReadStrings(arg0 Rows) ([]string, error) {
	m.ctrl.T.Helper()
...
func (m *MockDBClient) Upsert(arg0 TXClient, arg1 *sql.Stmt, arg2 string, arg3 interface{}, arg4 bool) error {
	m.ctrl.T.Helper()
